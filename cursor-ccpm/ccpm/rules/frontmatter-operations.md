...
3. Always update `updated` field with current datetime (see `.cursor/ccpm/rules/datetime.md`)
...
- Always use real datetime from system (see `.cursor/ccpm/rules/datetime.md`)
