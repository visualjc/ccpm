...
echo "┌─────────────────────────────────┐"
echo "│ Cursor CCPM Project Management  │"
...
echo "🚀 Initializing Cursor CCPM System"
echo "======================================"
echo ""
...
mkdir -p .cursor/ccpm/prds
mkdir -p .cursor/ccpm/epics
mkdir -p .cursor/ccpm/rules
mkdir -p .cursor/ccpm/agents
mkdir -p .cursor/ccpm/scripts/pm
echo "  ✅ Directories created"

# Copy scripts if in main repo
if [ -d "scripts/pm" ] && [ ! "$(pwd)" = *"/.cursor/ccpm"* ]; then
  echo ""
  echo "📝 Copying PM scripts..."
  cp -r scripts/pm/* .cursor/ccpm/scripts/pm/
  chmod +x .cursor/ccpm/scripts/pm/*.sh
