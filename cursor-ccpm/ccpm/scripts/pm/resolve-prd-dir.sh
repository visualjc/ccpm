...
# 2) .cursor/ccpm/.ccpmrc PRD_DIR value
# 3) Default: .cursor/ccpm/prds
#
# Behavior:
# - Outputs a repo-relative path (e.g., "docs/prds" or ".cursor/ccpm/prds")
