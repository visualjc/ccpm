...
test -f .cursor/ccpm/testing-config.md || echo "❌ Testing not configured. Run /testing:prime first"
```
...
Use the test-runner agent from `.cursor/ccpm/agents/test-runner.md`:
