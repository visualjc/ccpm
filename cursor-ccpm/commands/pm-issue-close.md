...
If progress file exists at `.cursor/ccpm/epics/{epic}/updates/$ARGUMENTS/progress.md`:
- Set completion: 100%
...
epic_issue=$(grep 'github:' .cursor/ccpm/epics/$epic_name/epic.md | grep -oE '[0-9]+$')
...
Follow `.cursor/ccpm/rules/frontmatter-operations.md` for updates.
Follow `.cursor/ccpm/rules/github-operations.md` for GitHub commands.
