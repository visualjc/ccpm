...
Check all task files in `.cursor/ccpm/epics/$ARGUMENTS/`:
...
If yes:
- Move epic directory to `.cursor/ccpm/epics/.archived/{epic_name}/`
...
{If archived}: Archived to .cursor/ccpm/epics/.archived/
