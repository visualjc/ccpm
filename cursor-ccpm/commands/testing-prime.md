...
Create `.cursor/ccpm/testing-config.md` with discovered information:
...
## Execution Rules
1. Always use the test-runner agent from `.cursor/ccpm/agents/test-runner.md`
...
- Store in `.cursor/ccpm/testing-config.md`
