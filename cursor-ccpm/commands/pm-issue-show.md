...
- Look for local task file: first check `.cursor/ccpm/epics/*/$ARGUMENTS.md` (new naming)
...
```
📁 Local Files:
   Task file: .cursor/ccpm/epics/{epic_name}/{task_file}
   Updates: .cursor/ccpm/epics/{epic_name}/updates/$ARGUMENTS/
